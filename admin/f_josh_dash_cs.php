...
function josh_dash_cs() {
    ...
    global $wpdb;
        ...
        $time = $GLOBALS['donasiaja_vars']['date_expired'];

        echo '<pre>';
        echo 'expired : '; echo $GLOBALS['donasiaja_vars']['expired']; echo '<br>';
        echo 'date ex : '; echo date("d M Y - H:i:s",$time) ; echo ', before : ' ; echo $time; echo '<br>';
        echo 'plugin name : '; echo $GLOBALS['donasiaja_vars']['plugin_name']; echo '<br>';
        echo 'version : '; echo $GLOBALS['donasiaja_vars']['plugin_version']; echo '<br>';
        echo 'license : '; echo $GLOBALS['donasiaja_vars']['plugin_license']; echo '<br>';
        echo 'api key : ';echo $GLOBALS['donasiaja_vars']['apikey']; echo '<br>';
        echo 'api status : ';echo $GLOBALS['donasiaja_vars']['apikey_status']; echo '<br>';
        echo 'info : ';echo $GLOBALS['donasiaja_vars']['plugin_check_info']; echo '<br>';
        echo 'activate : ';echo $GLOBALS['donasiaja_vars']['activate']; echo '<br>';
        echo '</pre>';
                                    ...
                                    <div class="icon-contain">
                                        <div class="row">
                                            <div class="col-10 align-self-center">
                                                ...
                                                <p class="text-muted mb-0">Konversi donasi berhasil terkumpul</p>
                                            </div><!--end col-->
                                            <div class="col-2 align-self-center">
                                                <div class="">
                                                    <div class="icon-info mb-3">
