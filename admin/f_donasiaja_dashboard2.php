...
function donasiaja_dashboard() {
    ...
    .custom-control-input:checked ~ .custom-control-label::before, #josh-only-ads-toggle::before {
        color: #fff;
        border-color: #36bd47;
...
Terimakasih 😊🙏</textarea>
    ...
    <?php }else{ ?>
            ...
            <div class="page-content-tab">
                ...
                <div class="container-fluid">    
                    ...
                    <div class="row"> 
                                        ...
                                        <div id="by_date_box" class="btn-group ml-1">
                                            ...
                                            <div id="by_date_list" class="dropdown-menu" style="<?php if($role=='donatur' || $role=='cs'){echo 'margin-left:-108px;}';}?>">
                                                <?php if(isset($_GET['id'])){ ?>
                                                    <a class="dropdown-item <?php if($date_filter_title=='today'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard&id=').$_GET['id'].'&date=today';?>">Today</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='yesterday'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard&id=').$_GET['id'].'&date=yesterday';?>">Yesterday</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='7lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard&id=').$_GET['id'].'&date=7lastdays';?>">7 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='30lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard&id=').$_GET['id'].'&date=30lastdays';?>">30 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='thismonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard&id=').$_GET['id'].'&date=thismonth';?>">This Month</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='lastmonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard&id=').$_GET['id'].'&date=lastmonth';?>">Last Month</a>
                                                    <a class="dropdown-item daterange <?php if($date_filter_title=='daterange'){echo'active';}?>" href="javascript:;" data-link="<?php echo admin_url('admin.php?page=donasiaja_dashboard&id=').$_GET['id'].'&date=daterange';?>">Date Range</a>
                                                    <a class="dropdown-item <?php if($date_filter_title==null || $date_filter_title=='all'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard&id=').$_GET['id'].'&date=all';?>">All</a>
                                                <?php } else { ?>
                                                    <a class="dropdown-item <?php if($date_filter_title=='today'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard').'&date=today';?>">Today</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='yesterday'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard').'&date=yesterday';?>">Yesterday</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='7lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard').'&date=7lastdays';?>">7 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='30lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard').'&date=30lastdays';?>">30 Last days</a>
                                                    <!-- <a class="dropdown-item" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard').'&date=3months';?>">3 Months ago</a> -->
                                                    <a class="dropdown-item <?php if($date_filter_title=='thismonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard').'&date=thismonth';?>">This Month</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='lastmonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard').'&date=lastmonth';?>">Last Month</a>
                                                    <a class="dropdown-item daterange <?php if($date_filter_title=='daterange'){echo'active';}?>" href="javascript:;" data-link="<?php echo admin_url('admin.php?page=donasiaja_dashboard').'&date=daterange';?>">Date Range</a>
                                                    <a class="dropdown-item <?php if($date_filter_title==null || $date_filter_title=='all'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiaja_dashboard').'&date=all';?>">All</a>
                                                <?php } ?>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-total-spent">
                            <div class="card <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>" style="border-bottom: 4px solid #11a5ed;-webkit-box-shadow: 0 6px 12px rgba(164, 192, 217, 0.3);-moz-box-shadow: 0 6px 12px rgba(164, 192, 217, 0.3);">
                                <div class="card-body">
                                    <div class="icon-contain">
                                        <div class="row">
                                            <div class="col-10 align-self-center">
                                                <h5 class="">Total Spent</h5>
                                                <h2 class="my-2">Rp&nbsp;<span id="totalSpent">...</span></h3>
                                                <p class="text-muted mb-0">Total spent pada facebook ads</p>
                                            </div><!--end col-->
                                            <div class="col-2 align-self-center">
                                                <div class="">
                                                    <div class="icon-info mb-3">
                                                        <i class="dripicons-shopping-bag bg-soft-secondary"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>  <!--end row-->                                                      
                            ...
                            <div class="card  <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>" style="max-width: 100%;">
                                <div class="card-body">
                                    ...
                                    <div style="margin: 3px 0 10px 0;">
                                        <input type="checkbox" id="josh-only-ads-toggle" class="">
                                        <label for="josh-only-ads-toggle">Only Ads Data (utm_source = fb, ig, dan an)</label>
                                    </div>
        ...
        jQuery(document).ready(function($){
            ...
            var joshAdsToggle = false
            
            $('#josh-only-ads-toggle').change(function (e) { 
                e.preventDefault();
                
                // console.log(e)
                // joshAdsToggle = ($('#josh-only-ads-toggle').attr('checked') === true ) ? 1 : 0
                joshAdsToggle = e.delegateTarget.checked
    
                console.log(joshAdsToggle)
                // console.log(e.delegateTarget.checked)
                j_dataTables.ajax.reload()
            });
            ...
            var j_dataTables = $('#datatables').DataTable( {
                "processing": true,
                "serverSide": true,
                "dom": "lifrtp",
                "ajax": {
                ...
                if( datePreset.range !== '' ) {
                    var [since, until] = datePreset.range.split('_')
                    // console.log( since )
                    // console.log( until )
                    dateRange = {since, until}
                    dateRange = JSON.stringify( dateRange )
                    dateTitle = 'time_range'
                    // console.log( dateRange )
                } else {
                    if( datePreset.filter === '7lastdays' ) {
                        dateRange = 'last_7d'
                    }
                    else if( datePreset.filter === '30lastdays' ) {
                        dateRange = 'last_30d'
                    }
                    else if( datePreset.filter === 'thismonth' ) {
                        dateRange = 'this_month'
                    }
                    else if( datePreset.filter === 'lastmonth' ) {
                        dateRange = 'last_month'
                    }
                    else if( datePreset.filter === 'all' ) {
                        dateRange = 'maximum'
                    }
                    else {
                        dateRange = datePreset.filter
                    }
