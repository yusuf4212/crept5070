<?php
	...
	$all_payment1 = $wpdb->get_results("SELECT * FROM ".$table_name2. " WHERE type='bank_account'")[0];
	$all_payment2 = $all_payment1->data;
...
<head>
	...
	<!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-10989129989"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
    
    gtag('config', 'AW-10989129989');
	<?php if($total < $max_value) { ?>
    gtag('event', 'conversion', {
      'send_to': 'AW-10989129989/57LcCI2Iu4AYEIWig_go',
...
<body>
    ...
    <!-- End Google Tag Manager (noscript) -->
		...
		<div id="typ_section" class="section-box" style="background: url('<?php echo plugin_dir_url( __FILE__ ).'assets/images/bg3.png'; ?>') no-repeat, #fff;">
			...
			<img alt="Donasi Aja" class="" src="<?php //echo $logo_url; ?>https://ympb.or.id/wp-content/uploads/2022/11/Desain-tanpa-judul-7-min.png" style="width: 200px;border-radius:4px;margin-bottom: -18px;">
			</div>

				<div class="title" style="margin-bottom: 30px;">
					<p class="typ_text">Terimakasih, <b><?php echo $donatur; ?></b><br>atas <?php echo $donasi_text; ?> yang akan Anda berikan pada program ini :</p>
				...
				<div class="jrekening">
					<div class="grid" style="display: grid; grid-template-columns: auto auto; column-gap: 10px; row-gap: 15px; margin-bottom: 20px;">
						<?php for($i=0; $i< 4; $i++) : ?>
							<div class="box-card no_rekening josh" >
								...
								<ul>
									...
									<li class="copy copy-rek" data-salin="<?php echo preg_replace('/\D/', '', $payment_number); ?>"><img src="<?php echo plugin_dir_url( __FILE__ ) . 'assets/icons/copy.png'; ?>">Copy Rekening</li>
								</ul>
						...
						<?php endfor ?>
						<!-- <div class="box-card no_rekening josh" >
							<div class="box-img"><img src="<?php //echo plugin_dir_url( __FILE__ ) . 'assets/images/bank/'.$code_bank[1][0].'.png'; ?>"></div>
							<ul>
								<li class="bank-name"><?php //echo preg_replace('/\D/', '', $name_bank[1][0]) ?></li>
								<li class="bank-number"><?php //echo $name_bank[1][1]; ?></li>
								<li class="copy copy-rek" data-salin="<?php //echo preg_replace('/\D/', '', $payment_number); ?>"><img src="<?php //echo plugin_dir_url( __FILE__ ) . 'assets/icons/copy.png'; ?>">Copy Rekening</li>
							</ul>
							<div class="box-copy josh"><span class="typ-rek-copy" data-salin="<?php //echo preg_replace('/\D/', '', $name_bank[1][0]); ?>" style="background: transparent;color: #888095;"><img src="<?php //echo plugin_dir_url( __FILE__ ) . 'assets/icons/copy.png'; ?>"> COPY</span></span></div>
						</div> -->
					</div>
				</div>
				...
				<div class="box-card2">
					...
					<?php 
					$strJsonFileContents = file_get_contents(plugin_dir_url( __FILE__ )."library/instructions.json");
					...
					if($i>=0){
						echo '<h3 style="text-align: center;margin-bottom: 20px;margin-top: 20px;">Instruksi Pembayaran</h3>';
					}
	...
	<div class="section-box box-powered" style="box-shadow: none;background: transparent;">
		...
		<p style="color: #9aabc8;margin-top: -8px;text-align: center;padding-top: 30px;">Ingin lihat program lainnya?<br><a href="<?php echo $home_url; echo '/donasi'; ?>" target="_self" style="text-decoration: none;color: #1c75ba;">Klik disini</a></p>
