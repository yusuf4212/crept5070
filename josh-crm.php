...
<!-- custom js -->
<script defer src="<?php echo DJA_PLUGIN_URL . 'assets/asset-j/crm-rsheet/jh-crm-rsheet-bootstrap.js?v1.3.2' ?>"></script>
...
<script>
    ...
    $(document).ready(function () {
        $('#btn-login-google').click(function (e) { 
            e.preventDefault();
            window.open('<?php echo $Google->login_url; ?>', '_blank');
        });
    });
</script>
...
<div class="josh-wrapper">
    ...
    <div class="container-fluid px-0 mx-0 mt-3 data-table-1" style="font-size: 14px;">
        <div class="row head-control py-2 gap-2 gap-sm-0 me-sm-2">
            <div class="col">
                <button type="button" class="btn btn-primary btn-sm" id="btn-login-google">Google Login</button>
            </div>
